...
print("Best case scenario, index found at",
      linear_search(list(np.arange(1, 7, 1)), 6, 1))
print("Worst case scenario, index found at",
      linear_search(list(np.arange(1, 7, 1)), 6, 7))
